...
export const DEFAULT_LAUNCHER_ICON: LucideIcon = LayoutGrid;

export const LAUNCHER_NAV_META: Partial<Record<WidgetType, LauncherNavMeta>> = {
  dashboard: {
    type: "dashboard",
...
export const LAUNCHER_QUICK_ACTION_LABEL_KEYS: Partial<Record<WidgetType, string>> = {
...
export const LAUNCHER_MOBILE_NAV_LABEL_KEYS: Partial<Record<WidgetType, string>> = {
