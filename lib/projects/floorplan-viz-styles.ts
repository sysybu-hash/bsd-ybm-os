...
- ONE seating group in the apartment, in the room where the plan draws sofas or armchairs. The entrance is circulation: bare floor, at most a console, a mirror or a coat hook. No sofa, no armchair, no rug, no coffee table, no bookcase and no display shelving at the entrance, and no second lounge anywhere the plan does not draw one. A fitted unit goes where the sheet draws a symbol for it and nowhere else.
...
- That cabinet lives in the living or dining room and nowhere else. Not in the entrance, not in a hall, not in a bedroom, and never a second one.
