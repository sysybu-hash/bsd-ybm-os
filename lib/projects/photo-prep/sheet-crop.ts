...
import {
  ...
  innerSheetRect,
} from "@/lib/projects/photo-prep/paper-box";
import { detectInkCropBox } from "@/lib/projects/photo-prep/ink-box";
import {
  titleBlockCutX,
  titleDividerCutX,
} from "@/lib/projects/photo-prep/title-block";
import {
  peelIsolatedEdgeFrame,
  stripRightFrameRulesX,
  stripRightSparseChromeX,
  stripSheetFrameCorners,
} from "@/lib/projects/photo-prep/edge-frame";
...
export function sampleCornerBackdrop(
  data: Buffer,
  width: number,
  height: number,
  channels: number,
...
export function isRasterBackdropPixel(
  r: number,
  g: number,
  b: number,
