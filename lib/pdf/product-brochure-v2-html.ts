...
const SHOWCASES: Showcase[] = [
  ...
  },
  {
    ...
    features: ["צ'אט AI + Omnibar — פקודות בשפה חופשית", "מחברת AI לפרויקט — מקורות, תקציר, Gemini Live", "מחולל אפליקציות — form, table, dashboard, Composer", "מנוע רעיונות — הפעלת CRM, משימות, סריקה מהצ'אט", "Gemini 2.5 — תשובות בעברית"],
  },
  {
