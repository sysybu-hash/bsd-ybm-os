...
export const AUTOMATION_CATALOG: AutomationCatalogEntry[] = [
  ...
  { id: "open_project_board", labelHe: "מרכז פרויקטים / משימות", labelEn: "Projects hub / tasks", labelRu: "Центр проектов / задачи", keywords: ["פרויקטים", "לוח", "board", "משימות"] },
  { id: "open_erp_archive", labelHe: "ארכיון ERP", labelEn: "ERP archive", labelRu: "Архив ERP", keywords: ["ארכיון", "erp"] },
  { id: "open_dashboard", labelHe: "מרכז פיננסים", labelEn: "Finance hub", labelRu: "Центр финансов", keywords: ["דאשבורד", "dashboard", "פיננסים"] },
