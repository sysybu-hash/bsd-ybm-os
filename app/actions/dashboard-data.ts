...
async function fetchProjectsData(orgId: string, config: DataConfig): Promise<ChartDataPoint[]> {
...
async function fetchExpensesData(orgId: string, config: DataConfig): Promise<ChartDataPoint[]> {
...
async function fetchContactsData(orgId: string, config: DataConfig): Promise<ChartDataPoint[]> {
...
async function fetchTasksData(orgId: string, config: DataConfig): Promise<ChartDataPoint[]> {
  const where = { organizationId: orgId };
...
async function fetchIssuedDocumentsData(orgId: string, config: DataConfig): Promise<ChartDataPoint[]> {
  const where = { organizationId: orgId, deletedAt: null };
...
async function fetchCustomAppData(orgId: string, config: DataConfig): Promise<ChartDataPoint[]> {
