  ...
  return (
    <div dir="rtl" className="flex min-h-screen flex-col items-center justify-center bg-[#0a0c10] px-4 py-12 text-white">
      <div className="flex w-full max-w-sm flex-col gap-6 text-center">
        ...
        <p className="text-sm text-white/50">לא ניתן לטעון את עמוד אינטגרציית Google. נסה שוב.</p>
        ...
        <div className="flex justify-center gap-3">
          ...
          <Link href="/app" className="rounded-xl border border-white/10 px-5 py-2 text-sm font-bold text-white/80 hover:bg-white/5">חזרה לסביבת העבודה</Link>
        </div>
      </div>
    </div>
  );
