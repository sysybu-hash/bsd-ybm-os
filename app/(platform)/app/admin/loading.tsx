  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-4 border-b border-[color:var(--border-main)] px-6 py-4">
        ...
        <div className="h-6 w-44 animate-pulse rounded-lg bg-[color:var(--border-main)]" />
        <div className="flex-1" />
        <div className="h-8 w-24 animate-pulse rounded-lg bg-[color:var(--border-main)]" />
      </div>

      <div className="flex flex-1 overflow-hidden">
        {/* Sidebar tabs */}
        <aside className="hidden w-48 shrink-0 flex-col gap-2 border-l border-[color:var(--border-main)] bg-white/[0.02] p-3 md:flex">
          {Array.from({ length: 6 }).map((_, i) => (
            <div
              key={i}
              className="h-9 w-full animate-pulse rounded-lg bg-[color:var(--border-main)]"
        ...
        <main className="flex flex-1 flex-col gap-5 overflow-y-auto p-6">
          ...
          <div className="grid grid-cols-2 gap-4 sm:grid-cols-4">
            {Array.from({ length: 4 }).map((_, i) => (
              <div
                key={i}
                className="flex flex-col gap-2 animate-pulse rounded-2xl border border-[color:var(--border-main)] bg-[color:var(--surface-card)] p-4"
          ...
          <div className="flex flex-col gap-2 rounded-2xl border border-[color:var(--border-main)] bg-[color:var(--surface-card)] p-4">
            <div className="mb-2 h-5 w-36 animate-pulse rounded-lg bg-[color:var(--border-main)]" />
            {Array.from({ length: 8 }).map((_, i) => (
              ...
              >
                <div className="h-8 w-8 rounded-full bg-[color:var(--border-main)] shrink-0" />
                <div className="h-4 flex-1 rounded bg-[color:var(--border-main)]" />
                <div className="h-4 w-28 rounded bg-[color:var(--border-main)]" />
                <div className="h-6 w-16 rounded-full bg-[color:var(--border-main)]" />
              </div>
            ))}
          </div>
        </main>
