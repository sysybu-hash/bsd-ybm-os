...
import { resolveGeminiModelId, GEMINI_STABLE_TEXT_MODEL } from "@/lib/gemini-model";
...
const MODEL = resolveGeminiModelId(env.GEMINI_OMNI_VOICE_MODEL?.trim() || GEMINI_STABLE_TEXT_MODEL);
