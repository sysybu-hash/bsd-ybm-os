...
export default function MarketingNavbar({ onLogin, onRegister, variant = "top" }: Props) {
  ...
  // Two independent overlays: `menuOpen` is the mobile menu on the live top nav,
  // `drawerOpen` is the side drawer used by variant="drawer". Only one variant
  // renders at a time, but both share the escape/scroll-lock behaviour below.
