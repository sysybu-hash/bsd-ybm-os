      ...
      <AnimatePresence>
        {open && activeTab ? (
          <motion.aside
            ...
            className="fixed z-[1185] flex flex-col overflow-hidden border-[color:var(--border-main)] bg-[color:var(--glass-bg)] shadow-lg backdrop-blur-sm
              inset-inline-end-[var(--os-utility-rail-tab-width)]
