      ...
      <AnimatePresence mode="wait">
        {hasHydrated && visibleWidgets.length === 0 && (
          <motion.section key="empty-state"
            ...
            className={`absolute inset-0 z-10 flex min-h-0 flex-col items-center overflow-x-hidden overflow-y-auto overscroll-contain p-4 pb-[calc(7rem+env(safe-area-inset-bottom))] md:justify-start md:gap-6 md:px-6 md:pb-8 ${
