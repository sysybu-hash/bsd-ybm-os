  ...
  return (
    <div className={`relative ${className}`}>
      <button
        ...
        onClick={() => setOpen((v) => !v)}
        disabled={pending}
        className={`flex items-center justify-center gap-1.5 rounded-lg border border-[color:var(--border-main)] bg-[color:var(--surface-card)] font-bold text-[color:var(--foreground-muted)] transition hover:bg-[color:var(--surface-soft)] hover:text-[color:var(--foreground-main)] disabled:opacity-60 ${
