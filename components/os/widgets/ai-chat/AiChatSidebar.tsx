      ...
      <div className="flex-1 min-h-0 overflow-y-auto custom-scrollbar p-4">
        ...
        <div className="space-y-1">
          {["ניתוח תקציב וילה", "השוואת מחירי בטון", "דרישות בטיחות אתר"].map((h, i) => (
            <button
              key={i}
              className="w-full flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-[color:var(--foreground-muted)]/5 text-[color:var(--foreground-muted)] hover:text-[color:var(--foreground-main)] text-xs font-medium transition-all truncate text-start"
            >
