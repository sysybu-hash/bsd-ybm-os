...
type AiChatMessagesProps = {
  ...
  isLoading: boolean;
  chatTab: "live" | "text";
  chatEndRef: React.RefObject<HTMLDivElement | null>; // cast at usage
  t: (key: string) => string;
  children?: React.ReactNode; // slot for GeminiLivePanel
};

export function AiChatMessages({ messages, isLoading, chatTab, chatEndRef, t, children }: AiChatMessagesProps) {
  return (
