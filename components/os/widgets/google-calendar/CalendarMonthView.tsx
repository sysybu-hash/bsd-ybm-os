  ...
  return (
    ...
    <div className="flex flex-col flex-1 min-h-0 overflow-hidden">
      ...
      {canWrite ? (
        ...
        <p className="text-[10px] text-[color:var(--foreground-muted)] px-4 py-1 shrink-0">{dragHintLabel}</p>

      ) : null}

      <div className="grid grid-cols-7 border-b border-[color:var(--border-main)]/50 shrink-0">
        ...
        {weekdayLabels.map((label) => (
          ...
          <div
            ...
            className="text-center text-[10px] font-black uppercase text-[color:var(--foreground-muted)] py-2"
      ...
      <div
        ...
        className="grid grid-cols-7 flex-1 min-h-0 auto-rows-fr"

        onPointerUp={() => {

          if (dragging.current) void finishMonthDrag();
        ...
        {monthDays.map((day) => {
          ...
          return (
            ...
            <button
              ...
              className={`flex flex-col min-h-[72px] border border-[color:var(--border-main)]/40 p-1 text-start transition-colors ${

                inRange ? "bg-violet-500/15 ring-1 ring-violet-500/40" : ""

              } ${

                selected ? "ring-2 ring-violet-500/50 z-[1]" : ""
            ...
            >
              ...
              <div className="flex items-center justify-between gap-1">
                ...
                <span
                  ...
                  className={`text-xs font-black tabular-nums w-6 h-6 flex items-center justify-center rounded-full ${
                ...
                {dayEvents.slice(0, MAX_VISIBLE).map((ev) => {
                  ...
                  return (
                    ...
                    <div
                      ...
                      className="gcal-event-chip truncate rounded px-1 py-0.5 text-[9px] font-bold border"
