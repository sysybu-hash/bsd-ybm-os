  ...
  return (
    <div className="flex w-full flex-col border-[color:var(--border-main)] bg-[color:var(--surface-soft)]/50 p-4 md:w-1/3 md:border-l">
            ...
            {savedList.length === 0 ? (
              ...
              savedList.map((nb) => (
                ...
                >
                  ...
                  <ItemActions onDelete={() => onDeleteSaved(nb.id)} deleteLabel="מחק מחברת" />
                </motion.div>
              ))
            )}
          </motion.div>
      ...
      >
        ...
        <p className="text-sm font-medium text-[color:var(--foreground-muted)]">גרור קבצים או לחץ להעלאה</p>
